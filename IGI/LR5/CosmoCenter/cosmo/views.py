...
from .forms import OfferRentForm, OfferImmForm, CommentForm
from .models import New, FAQ, Vacancion, Rent, Discount, Contact, Comment, Time, Report, Immovables, RequestRent, RequestImm, Doctor
...
def index(request):
    ...
    let = 53.893009
    lon = 27.567444
    api_key = 'cc8d9233ff1c50560faf32d331070ec3'
    data = []
    data1 = []
    try:
